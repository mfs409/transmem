...
// This group consists of the serial and serialirr
...
// [transmem] This may not be needed anymore
class serialirr_dispatch : public abi_dispatch
{
 ...
 public:
  ...
  virtual abi_dispatch* closed_nesting_alternative()
  {
    ...
    // undo logging.
    //
    // [transmem] Not supported
    return 0;
  }
};

// [transmem] removed serial_dispatch and serialirr_onwrite_dispatch
...
// [transmem] removed o_serial_dispatch and o_serialirr_onwrite_dispatch
...
// [transmem] Removed dispatch_serial and dispatch_serialirr_onwrite
...
GTM::gtm_thread::serialirr_mode ()
{
  ...
  // [transmem] there is no serial_lock, so write_upgrade() always succeeds,
  //            and write_upgrade_finish is a no-op
  else if (true)
    {
