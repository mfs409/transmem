...
static intmap* modifier_map = NULL;
...
void modifier_tests(int id)
{
    ...
    global_barrier->arrive(id);
    {
        verifier v;
        BEGIN_TX;
        modifier_map = new intmap();
        modifier_map->emplace(42, 42);
        v.insert_all<intmap>(modifier_map);
        delete(modifier_map);
        modifier_map = NULL;
        END_TX;
    ...
    global_barrier->arrive(id);
    {
        ...
        BEGIN_TX;
        modifier_map = new intmap();
        modifier_map->emplace_hint(modifier_map->begin(), 42, 42);
        v.insert_all<intmap>(modifier_map);
        delete(modifier_map);
        modifier_map = NULL;
        END_TX;
    ...
    global_barrier->arrive(id);
    {
        ...
        BEGIN_TX;
        modifier_map = new intmap();
        modifier_map->insert(std::make_pair(23, 23));
        v.insert_all<intmap>(modifier_map);
        delete(modifier_map);
        modifier_map = NULL;
        END_TX;
    ...
    global_barrier->arrive(id);
    {
        ...
        BEGIN_TX;
        modifier_map = new intmap();
        modifier_map->insert(modifier_map->begin(), {42, 42});
        v.insert_all<intmap>(modifier_map);
        delete(modifier_map);
        modifier_map = NULL;
        END_TX;
    ...
    global_barrier->arrive(id);
    {
        ...
        BEGIN_TX;
        modifier_map = new intmap();
        modifier_map->insert(modifier_map->begin(), std::make_pair(23, 23));
        v.insert_all<intmap>(modifier_map);
        delete(modifier_map);
        modifier_map = NULL;
        END_TX;
    ...
    global_barrier->arrive(id);
    {
        ...
        BEGIN_TX;
        modifier_map = new intmap();
        modifier_map->insert(other.begin(), other.end());
        v.insert_all<intmap>(modifier_map);
        delete(modifier_map);
        modifier_map = NULL;
        END_TX;
    ...
    global_barrier->arrive(id);
    {
        verifier v;
        BEGIN_TX;
        modifier_map = new intmap({{1, 1}, {2, 2}, {3, 3}});
        modifier_map->erase(modifier_map->begin());
        v.insert_all<intmap>(modifier_map);
        delete(modifier_map);
        modifier_map = NULL;
        END_TX;
    ...
    global_barrier->arrive(id);
    {
        ...
        BEGIN_TX;
        modifier_map = new intmap({{1, 1}, {2, 2}, {3, 3}});
        modifier_map->erase(modifier_map->begin(), modifier_map->end());
        v.insert_all<intmap>(modifier_map);
        delete(modifier_map);
        modifier_map = NULL;
        END_TX;
