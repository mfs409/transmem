...
// this file is from RSTM, which used a library interface.  In that code,
// every read and write was manually instrumented via macros like this one.
...
// If v is in tree, remove it, else insert it
