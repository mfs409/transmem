...
public:
  ...
  ///Copy Constructor
  // [transmem] Need this to be safe so we can copy vectors of FlexImages in
  //            transactions
  __attribute__((transaction_safe))
  ...
  // [transmem] Destructor needs to be safe
  __attribute__((transaction_safe))
  ~FlexImage();
